...
nale_array <- nale_array[6:14,,2:3] # subset the two specimens, and only their common landmarks
nale_array_gpa <- gpagen(nale_array)
summary(nale_array_gpa)

# sediba
sedi_array_gpa <- gpagen(sedi_array)
summary(sedi_array_gpa)

# troglodytes
trog_array_gpa <- gpagen(trog_array)
